...
/// <param name="sectionName">The name of the configuration section to associate with the class. If null or not specified, a default section name will be used.</param>
